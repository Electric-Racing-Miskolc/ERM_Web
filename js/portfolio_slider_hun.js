...
$("#elastic_grid_demo").elastic_grid({	
	...
	'items' :
		[
			...
			{
			'title' : 'EuroSolid Zrt. Szponzoráció',
			'description'   : 'Szeretnénk megköszönni az EuroSolid Zrt.-nek a támogatást, akik segítségével a 3DEXPERIENCE platformhoz és számos más segédprogramhoz hozzáférést, illetve oktatást kapunk, így egy felhő alapú rendszerben tudjuk nyomon követni munkánkat. 2022.12.08.',
			'thumbnail' : ['img_smoll/portfolio/small/No5.webp'],
			'large' : ['img_smoll/portfolio/large/No5.webp'],
			'button_list'   :
			[
			...
			{
			'title' : 'UniTek Szponzoráció',
			'description'   : 'Ezúton szeretnénk megköszönni az Unitek Drives cégének, hogy támogatt elektromos autónk építésében, illetve a Miskolci Egyetem beszerzésben nyújtott segítségét. 2022.11.21.',
			'thumbnail' : ['img_smoll/portfolio/small/No4.webp'],
			'large' : ['img_smoll/portfolio/large/No4.webp'],
			'button_list'   :
			[
			...
			'thumbnail' : ['img_smoll/portfolio/small/No3.webp'],
			'large' : ['img_smoll/portfolio/large/No3.webp'],
			'button_list'   :
			[
			...
			{
			'title' : 'Csapat alapítási interjú',
			'description'   : 'Lelkes, fiatal és kreatív csapat az Electric Racing Miskolc. Mit csinálnak? Videónkból kiderül. És még lehet csatlakozni. 2022.10.13',
			'thumbnail' : ['img_smoll/portfolio/small/No2_1.webp', 'img_smoll/portfolio/small/No2_2.webp'],
			'large' : ['img_smoll/portfolio/large/No2_1.webp', 'img_smoll/portfolio/large/No2_2.webp'],
			'button_list'   :
			[
			...
			{
			'title' : 'The Beginning...',
			'description'   : 'Örömmel jelentjük be, hogy megalakult a Miskolci Egyetem első, 100 %-ban elektromos meghajtású versenyautót fejlesztő Formula Student csapata! Csapatunk Electric Racing Miskolc néven, a Miskolci Egyetemet képviselve méretteti meg magát a Formula Student nemzetközi hallgatói versenysorozatban. 2022.11.11.',
			'thumbnail' : ['img_smoll/portfolio/small/No1.webp'],
			'large' : ['img_smoll/portfolio/large/No1.webp'],
			'button_list'   :
			[
